...
final List<Symptom> symptomEntries = [
  Symptom(
  ...
  Symptom(
      ...
      content: Text.rich(
        ...
        TextSpan(
          ...
          children: [
            TextSpan(text: trimLeadingWhitespace("""
              $indentสาเหตุของโรคลมชักเกิดจากภาวะใดๆก็ตามที่ก่อให้เกิดรอยโรคในสมอง เช่น อุบัติเหตุ, การติดเชื้อในสมอง,เนื้องอก และ ความผิดปกติของสมองแต่กำเนิดเป็นต้น
              $indentอย่างไรก็ดี การชักในเด็กส่วนใหญ่ โดยเฉพาะ เด็กที่มีพัฒนาการปกติมักตรวจไม่พบความผิดปกติของสมองใดๆ จากการตรวจทางรังสีวินิจฉัย
              
              การตรวจวินิจฉัย
              $indentการวินิจฉัยโรคลมชักเพื่อให้ทราบถึงสาเหตุที่แท้จริงมีความสำคัญ เพราะทำให้ได้การรักษาที่มีประสิทธิภาพ นอกจากแพทย์จะทำการซักประวัติอย่างละเอียดแล้ว ยังมีเครื่องมือที่ทันสมัย เพื่อช่วยยืนยันการวินิจฉัยเช่น 
              
              การตรวจคลื่นไฟฟ้าสมอง (EEG)
              $indentช่วยวินิจฉัยโรคลมชัก และทำให้สามารถบอกตำแหน่งของสมองที่เกิดการชักและชนิดของการชักได้
              
              การตรวจเอกซเรย์คอมพิวเตอร์ (CT Scan) และการทำเอ็มอาร์ไอ (MRI)
              $indentช่วยให้แพทย์เห็นภาพความผิดปกติของสมองที่เป็นสาเหตุของโรคลมชักได้""")
            ),
          ],
        ),
      ),
  ...
  Symptom(
      ...
      content: Text.rich(
        ...
        TextSpan(
          ...
          children: [
            TextSpan(text: trimLeadingWhitespace("""
              $indentในปีพ.ศ. 2560 สมาพันธ์ต่อต้านโรคลมชักนานาชาติ(International League Against Epilepsy, ILAE) ได้มีการทบทวนและ เปลี่ยนแปลงคำจำกัดความและการจำแนกชนิด ของอาการชัก โดยจำแนกเป็น 3 ชนิด ได้แก่ 
              
              ${indent}1. อาการชักที่มีจุดกำเนิดเฉพาะที่ (focal onset) 
              $indentคือ อาการชักที่เกิดจากการเปลี่ยนแปลงของคลื่นไฟฟ้าสมองของสมองเฉพาะบางจุด โดยจำแนกอาการชักแบบเฉพาะที่เป็น 3 ชนิดย่อยดังนี้ 
              ...
              $indentคืออาการชักที่เกิดจากการเปลี่ยนแปลงของคลื่นไฟฟ้าสมองทั้ง 2 ซีกตั้งแต่เริ่มต้นของการชัก มีชนิดของอาการชักที่พบได้บ่อยได้แก่อาการชักแบบเหม่อ (Absence seizure) อาการชักสะดุ้ง (myoclonic seizure) และอาการชักชนิดตัวอ่อน (Atonic seizure ) อาการชักกระตุกทั้งตัว (generalized tonic-clonic seizure) เป็นต้น 
              
              ${indent}3. อาการชักที่ไม่ทราบจุดกำเนิดชัดเจน (Unknown onset) 
              $indentคืออาการชักที่ไม่ทราบจุดกำเนิดของคลื่นชัก ไม่สามารถเข้าได้กับ สองชนิดแรกอาจแยกย่อยเป็น อาการชักแบบเกร็งกระตุก (tonic-clonic), อาการชักแบบผวา (epileptic spasms) หรือแบบหยุดพฤติกรรมที่ทำอยู่ (behavior arrest)เป็นต้น
              """)
            ),
          ],
        ),
        ...
        TextSpan(
          ...
          children: [
            TextSpan(text: trimLeadingWhitespace("""
              ...
              $indentวิธีการปฐมพยาบาล ผู้ป่วยขณะชัก
